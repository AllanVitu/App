<script setup>
/**
 * Avertit que la liste affichée est INCOMPLÈTE.
 *
 * ┌─────────────────────────────────────────────────────────────────────┐
 ...
 * │  droit de laisser croire qu'elle montre tout.                       │
 * └─────────────────────────────────────────────────────────────────────┘
 *
...
<template>
  <p
    v-if="hidden > 0"
    class="flex items-center gap-2 rounded-field border border-ochre/40 bg-ochre-bg px-3 py-2 text-[0.76rem] text-ochre"
    role="status"
  >
